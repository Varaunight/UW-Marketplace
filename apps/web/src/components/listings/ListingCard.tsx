...
export default function ListingCard({ listing }: { listing: Listing }) {
  ...
  return (
    <Link
      ...
      className="group block bg-surface rounded-xl overflow-hidden border border-border hover:border-gold hover:shadow-md transition-all"
    >
      <div className="relative h-48 bg-base">
        ...
        <span className="absolute top-2 left-2 bg-surface/90 backdrop-blur-sm text-xs font-medium px-2 py-1 rounded-full text-gray-600">
